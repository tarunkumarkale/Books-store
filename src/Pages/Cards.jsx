...
const Cards = ({name, price, imageURL,id,link}) => {
...
console.log(id)
  return (
   ...
   <div className="bg-black rounded-lg shadow-2xl p-4 flex flex-col align-middle w-[20%] m-3 hover:-translate-y-1 hover:scale-105">
    ...
    <button onClick={e => Navigate(link)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mx-auto">
      View
     </button>
   </div>
